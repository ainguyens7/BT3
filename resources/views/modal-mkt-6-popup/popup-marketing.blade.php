@extends('layout.backend',['page_title' => 'Marketing Popup'])
...
@section('container_content')
    <div class="home-wrap">
        <div class="home-container">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body ff-poppins">
                            ...
                            <img src="{{ url('images/backend/popup-mkt/pu1-arrow.png') }}" class="pu1-arrow">
                            <a href="#" class="fw600 fz18 ani-space-1px">Good for me, let's get some coffee!</a>
                            <p class="fw500i fz16 pumkt-sub-link"><a href="javascript:void(0)" data-dismiss="modal">I'm ok with that logo</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- POP-UP #2 -->
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#mkt-popup-2">Popup 2</button>

            <div class="modal fade spopup-mkt spopup-mkt" tabindex="-1" role="dialog" id="mkt-popup-2">
                <div class="modal-dialog" role="document">
                    <div class="modal-content spopup-mkt__style-2">
                        ...
                        <div class="modal-body ff-poppins pumkt-2 text-center">
                            ...
                            <p class="pumkt-2__description fz16" id="mkt-popup-2__description">
                            ...
                            <div class="pumkt-2__buttn-yes">
                                <a href="#" id="mkt-popup-2__yes-1">
                                    <img src="{{ url('images/backend/popup-mkt/pu2-btn-yes.png') }}" class="pu1-arrow ani-space-1px">
                                </a>

                                <a href="#" id="mkt-popup-2__yes-2" style="display: none;">
                                    <img src="{{ url('images/backend/popup-mkt/pu2-btn-yes-2.png') }}" class="pu1-arrow ani-space-1px">
                                </a>
                            </div>

                            <div class="pumkt-2__buttn-no">
                                <a href="#" class="ani-space-1px" id="mkt-popup-2__no-1" data-dismiss="modal"> No, not now</a>
                                <a href="#" class="ani-space-1px" id="mkt-popup-2__no-2" style="display: none;">I'll have to think about that</a>
                                <a href="#" class="ani-space-1px" id="mkt-popup-2__no-3" style="display: none;">Get my discount now and go Unlimited</a>
                            </div>
                        </div>
                    </div>
                </div>
