...
@section('breadcrumb')
    @include('partials/breadcrumb', ['breadcrumb_link' => 'Update Settings'])
@endsection
    ...
    <div class="wrapper-space wrapper-space--45 bg-white">
        <div class="general-setting-wrap">
            <div class="text-center">
                ...
                <form id="form_update_settings" method="post" action="{{route('cs.updateSettingAppCS')}}" >
                    <div class="clearfix fz21" style="margin: 15px 0 0 0;">
                        <p style="line-height: 1.8;" class="fz15 mar-b-0">
                            <strong>Update Ali Reviews settings</strong><br>

                        <br>
                        Please click the button below to continue
                        </p>
                    </div>
                    <button type="submit" class="button button--primary setting-submit-btn mar-t-30">{{__('cs.button_update_settings')}}</button>
                    {!! csrf_field() !!}
                </form>
            </div>
        </div>
