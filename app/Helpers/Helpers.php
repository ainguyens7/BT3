...
class Helpers
{
	...
	public static function transformValueArrayToString($array) {
...
color: white;
	...
	public static function shortName($name){
		...
		foreach ($args_name as $k => $v){
			if($k < 1){
				$first_char .= mb_substr($v,0,1,"UTF-8").'**';
			}else{
				$first_char .= '**';
			}
	...
	public static function tag_stylesheet($href = "")
	{
		return "<link rel=\"stylesheet\" href=\"{$href}\">";
	}

	public static function tag_script($src = "")
	{
		return "<script src=\"{$src}\" defer=\"defer\"></script>";
	}


	public static function generate_key_cache_hash()
	{
		return implode('_', func_get_args());
	}

	public static function generate_hash_field()
	{
		return implode('_', func_get_args());
	}
}