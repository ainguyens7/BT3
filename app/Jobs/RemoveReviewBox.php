...
class RemoveReviewBox implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $patternRemoveTemplate = '<div id="review-widget-box" data-shop-id="'.$this->_shopId.'" product-id="{{ product.id }}"> {{ product.metafields.alireviews.widget_review_box_key }} </div>'; 
